<main>
  ...
  <div>
    ...
    <article>
      <h2>Associate degree (2 jaar)</h2>
      <blockquote>“Een Associate degree-opleiding is een tweejarige hbo-opleiding op niveau 5.”</blockquote>
    </article>

    <article>
      <h2>Meeloopdagen</h2>
      <blockquote>Interesse? Of een keer meelopen? Kijk op <a href="https://fdnd.nl/" target="_blank">fdnd.nl</a> voor meer info.</blockquote>
    </article>
  </div>
